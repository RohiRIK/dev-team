...
1. **Check _research_cache folder:**
   ```bash
   ls -la _research_cache/
   ```

2. **Search for related topics:**
   ```bash
   grep -r "keyword" _research_cache/
   ```
...
```
_research_cache/YYYY-MM-DD/kebab-case-topic.md
```

**Examples:**
- `_research_cache/2025-10-27/oauth2-implementation.md`
- `_research_cache/2025-10-25/react-performance-optimization.md`
- `_research_cache/2025-10-20/postgresql-indexing-strategies.md`
...
**See also:**
- `_research_cache/2025-10-15/related-topic.md`
- `_research_cache/2025-10-10/another-related-topic.md`

**Supersedes:**
- `_research_cache/2025-09-20/old-version.md` (outdated)
...
1. **Check if today's folder exists:**
   ```bash
   ls -la _research_cache/ | grep $(date +%Y-%m-%d)
   ```

2. **Create folder if needed:**
   ```bash
   mkdir -p _research_cache/$(date +%Y-%m-%d)
   ```
...
5. **Update _research_cache/README.md:**
...
6. **Share via Agent Context Hub:**
   ...
   File: _research_cache/2025-10-27/oauth2-implementation.md
...
1. **Reference the source:**
   ```markdown
   Based on research from `_research_cache/2025-10-27/oauth2-implementation.md`:
   - [Key point 1]
   - [Key point 2]
   ```
...
4. **Credit in task summary:**
   ```markdown
   ## Research Sources
   - Reused research: `_research_cache/2025-10-27/oauth2-implementation.md`
...
2. **Archive or update:**
   - Move stale research to `_research_cache/archive/`
...
Track in `_research_cache/README.md`:
